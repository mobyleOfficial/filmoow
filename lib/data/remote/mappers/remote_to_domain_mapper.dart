...
extension MovieListingRemoteToDomain on MovieListingRemoteModel {
...
extension ListListingRemoteToDomain on ListsListingRemoteModel {
  ListsListing toDomain() => ListsListing(
        hasNext: hasNext,
        lists: lists
            .map(
              (list) => list.toDomain(),
